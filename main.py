...
if __name__ == '__main__':
    ...
    opt = {'base_lr': 1e-4, 'batch_size': 8, 'start_epoch':1, 'epochs': 6001, 'save_frequency': 100,
            'test_frequency': 10000, 'patch_size': 512, 'load_weigths': False, 'debug':False, 'dataparallel':True}

    print(f"debug mode: {opt['debug']}")
    print(f'dataparallel: {opt["dataparallel"]}')
    ...
    dataloader_train = DataLoader(train_dataset, batch_size=opt['batch_size'], shuffle=True, num_workers=4, pin_memory=True)
